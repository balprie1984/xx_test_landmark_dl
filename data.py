...
def get_data_loaders(
    ...
    class_names = [class_.split(".")[1].replace("_", " ") for class_ in train_data.classes]
    #print('mapping')
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    #class_names = [class_.split(".")[1].replace("_", " ") for class_ in labels]# YOUR CODE HERE
...
def test_data_loaders_keys(data_loaders):
    print ("Inside test_data_loaders_keys")
